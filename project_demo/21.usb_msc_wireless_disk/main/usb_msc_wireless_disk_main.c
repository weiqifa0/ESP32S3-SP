...
#define BOARD_SDCARD_SPI_CS_PIN GPIO_NUM_8
#elif defined(CONFIG_SDCARD_INTFC_SDIO) && defined(SOC_SDMMC_HOST_SUPPORTED)
#define BOARD_SDCARD_SDIO_CLK_PIN GPIO_NUM_3
#define BOARD_SDCARD_SDIO_CMD_PIN GPIO_NUM_4
#define BOARD_SDCARD_SDIO_DO_PIN GPIO_NUM_14
...
/* 初始化文件系统 可以初始化内部flash  也可以用外部TF卡  外部TF卡可以用SPI或者SDIO模式 在menuconfig里面配置 一般SPI不行的话就用SDIO*/
